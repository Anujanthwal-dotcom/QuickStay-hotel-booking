...
const AllRooms = () => {
  ...
  //function ---> for room match the selected room type
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div>
        <Title
          title={"Hotel Rooms"}
          subTitle={
            "Take advantage of our limited-time offers and special packages to enhance your stay experience."
          }
          align={"left"}
        />
          ...
          >
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <div className="flex items-center">
                <StarRating />
                <p className="ml-2">500+ Reviews</p>
              </div>
