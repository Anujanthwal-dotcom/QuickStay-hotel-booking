...
const Hero = () => {
  ...
  const onSearch =async (e)=>{
    ...
    setSearchedCities((prevSearchedCities)=>{
      if(prevSearchedCities===undefined) prevSearchedCities = [];
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white        bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      ...
      <p className="max-w-130 mt-2 mb-4 text-sm md:text-base">
        Unparalleled luxury and comfort awaits at the world's most exclusive
        hotels.
      </p>

      <form onSubmit={onSearch} className="bg-white text-gray-500 rounded-lg px-6 py-4 mt-4 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto">
        <div>
